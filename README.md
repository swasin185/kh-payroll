...
### 1 กรณีเต็มวัน (มีเวลาเข้างาน และ มีเวลาออกงาน)
...
### 2 กรณีครึ่งวัน (มีแค่เวลาเข้า หรือ มีแค่เวลาออก) และ มีเวลาพักเที่ยง
...
### 3 กรณีอื่นๆ (ไม่นับวันเวลาทำงาน)
...
./project
  ├── script                    # Script
  │   ├── sql                   # SQL Script
  │   │   ├── 1.table.sql       # Create Table
  │   │   ├── 2.view.sql        # Create View
  │   │   ├── 3.procedure.sql   # Create Procedure
  │   │   └── 4.event.sql       # Create Event
  │   ├── init-db.sh            # Initialize Database
  │   ├── restore.sh            # Restore Database
  │   └── backup.sh             # Backup Database
  ├── report                    # Jasper Report
  │   └── *.jrxml               # Jasper Report Source Files
  ├── .gitignore                # Git Ignore *.jasper *.zip
