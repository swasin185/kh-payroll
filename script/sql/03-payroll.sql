...
create table employee (
    ...
    extPhone       varchar(3) comment "เบอร์โทรภายใน (3 หลัก)",
    lineId         varchar(50) comment "Line ID / Social App ID",
    supplier       varchar(80) comment "บริษัทผู้จัดหา (Supplier) Brand ที่ดูแล",
