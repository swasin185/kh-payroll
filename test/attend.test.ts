...
describe("Payroll MariaDB", () => {
    ...
    const scenarios = [
        ...
        },
        {
            date: "2100-01-06",
            name: "OT Night 1",
            times: ["06:54", "12:32", "12:54", "17:31", "21:12"],
            expected: {
                morning: "06:54",
                lunch_out: "12:32",
                lunch_in: "12:54",
        ...
        {
            date: "2100-01-11",
            name: "Missing Lunch 2",
            times: ["07:50", "12:34", "17:05"],
            expected: {
                morning: "07:50",
                lunch_out: "12:34",
                lunch_in: "12:34",
        ...
        {
            date: "2100-01-12",
            name: "Missing Lunch 3",
            times: ["07:12", "14:39", "17:32"],
            expected: {
                morning: "07:12",
                lunch_out: null,
                lunch_in: "14:39",
        ...
        {
            date: "2100-01-15",
            name: "morning+MLunch+OT 2",
            times: ["07:23", "12:22", "20:58"],
            expected: {
                morning: "07:23",
                lunch_out: "12:22",
                lunch_in: "12:22",
        ...
        {
            date: "2100-01-16",
            name: "morning+MLunch+OT 3",
            times: ["07:23", "14:02", "20:05"],
            expected: {
                morning: "07:23",
                lunch_out: null,
                lunch_in: "14:02",
        ...
        {
            date: "2100-01-20",
            name: "HalfDay Morning 2",
            times: ["07:41", "12:23", "12:51"],
            expected: {
                morning: "07:41",
                lunch_out: "12:23",
                lunch_in: "12:51",
        ...
        },
        {
            date: "2100-01-27",
            name: "Spam Lunch Out",
            times: ["07:30", "11:54", "12:05", "12:10", "17:09"],
            expected: {
                morning: "07:30",
                lunch_out: "11:54",
                lunch_in: "12:10",
        ...
        {
            date: "2100-01-28",
            name: "HalfDay Afternoon 2",
            times: ["12:20", "12:50", "16:50"],
            expected: {
                morning: null,
                lunch_out: "12:20",
                lunch_in: "12:50",
    ...
    async function getScanCode(): Promise<string> {
        const [rows] = await db.query<any[]>(
            "SELECT scanCode FROM employee WHERE comCode=? AND empCode=?",
            [testComCode, testEmpCode],
        )
        ...
        if (!code) {
            ...
            code = "9999"
            await db.query("UPDATE employee SET scanCode=? WHERE comCode=? AND empCode=?", [
                code,
                testComCode,
                testEmpCode,
            ])
    ...
    async function setupData(scanCode: string) {
        await db.execute("INSERT IGNORE INTO holiday (comCode, day, name) VALUES (?, ?, ?)", [
            testComCode,
            "2100-01-01",
            "New Year",
        ])
