...
describe("Payroll MariaDB", () => {
    ...
    const scenarios = [
        {
            date: "2100-01-01", name: "Not Absent", times: [],
            expected: null
        },
        {
            date: "2100-01-02", name: "Normal 1", times: ["07:52", "12:12", "13:12", "17:05"],
        ...
        {
            date: "2100-01-04", name: "Normal 2", times: ["07:50", "12:14", "12:45", "17:30"],
        ...
        {
            date: "2100-01-05", name: "Normal 3", times: ["07:50", "12:11", "12:51", "16:30"],
        ...
        {
            date: "2100-01-06", name: "OT Night 1", times: ["06:54", "12:32", "12:54", "17:31", "21:12"],
        ...
        {
            date: "2100-01-07", name: "OT Night 2", times: ["07:32", "12:10", "12:55", "21:10"],
        ...
        {
            date: "2100-01-08", name: "OT Night 3", times: ["12:12", "12:55", "21:30"],
        ...
        {
            date: "2100-01-09", name: "OT Early", times: ["07:35", "12:05", "12:57", "02:02"],
        ...
        {
            date: "2100-01-11", name: "Missing Lunch 2", times: ["07:50", "12:34", "17:05"],
        ...
        {
            date: "2100-01-12", name: "Missing Lunch 3", times: ["07:12", "14:39", "17:32"],
        ...
        {
            date: "2100-01-13", name: "morning+OT", times: ["07:44", "12:01", "12:49", "20:31"],
        ...
        {
            date: "2100-01-14", name: "morning+MLunch+OT 1", times: ["07:39", "20:11"],
        ...
        {
            date: "2100-01-15", name: "morning+MLunch+OT 2", times: ["07:23", "12:22", "20:58"],
        ...
        {
            date: "2100-01-16", name: "morning+MLunch+OT 3", times: ["07:23", "14:02", "20:05"],
        ...
        {
            date: "2100-01-18", name: "morning+MLunch+early", times: ["07:21", "02:08"],
        ...
        {
            date: "2100-01-22", name: "Late Morning", times: ["08:20", "12:10", "13:01", "16:55"],
        ...
        {
            date: "2100-01-23", name: "Late Morning Half", times: ["08:30", "11:50"],
            expected: { morning: "08:30", lunch_out: "11:50", status: "HalfDay", workMin: 200, lateMin1: 30, lateMin2: 10 }
        },
        {
            date: "2100-01-25", name: "Late Lunch", times: ["07:30", "12:01", "13:23", "17:03"],
        ...
        {
            date: "2100-01-26", name: "Spam Morning", times: ["07:50", "08:02", "08:05", "16:55"],
            expected: { morning: "08:05", evening: "16:55", status: "FullDay", workMin: 230, lunchMin: 0, lateMin1: 5, lateMin2: 245 }
        },
        {
            date: "2100-01-27", name: "Spam Lunch Out", times: ["07:30", "11:54", "12:05", "12:10", "17:09"],
        ...
        {
            date: "2100-01-28", name: "HalfDay Afternoon 2", times: ["12:20", "12:50", "16:50"],
        ...
        {
            date: "2100-01-29", name: "Absent 1", times: ["12:01", "13:01"],
            expected: { lunch_out: "12:01", lunch_in: "13:01", status: "Absent" }
        },
        {
            date: "2100-01-30", name: "Absent 2", times: [],
            expected: { status: "Absent" }
        },
        {
            date: "2100-01-31", name: "Holiday", times: ["09:30", "12:30"],
            expected: { morning: "09:30", lunch_out: "12:30", otMin: 180, status: "Sunday" }
        }
    ]
    ...
    async function setupData(scanCode: string) {
        await db.execute("INSERT IGNORE INTO holiday (comCode, day, name) VALUES (?, ?, ?)", [testComCode, "2100-01-01", "New Year"])
    ...
    async function tearDownData(scanCode: string) {
        await db.execute("DELETE FROM holiday WHERE comCode=? AND day=?", [testComCode, "2100-01-01"])
        await db.execute(
